from flask import Flask, render_template_string, request, render_template_string, session, copy_current_request_context, \
    url_for, Markup, render_template, redirect
import json
...
fapp = Flask(__name__, template_folder='templates', static_url_path='', static_folder='')
